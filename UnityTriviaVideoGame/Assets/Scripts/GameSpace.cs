...
public class GameSpace : MonoBehaviour
{
    ...
    public List<GameObject> playersOnSpace;

    // Start is called before the first frame update
    void Start()
    {
        playersOnSpace = new List<GameObject>();
    }
    ...
    public virtual void MovePiece() { // Based on amount of players on space, move pieces to positions relative to space
        Vector3 newPos;
